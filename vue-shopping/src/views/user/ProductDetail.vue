            ...
            <div class="comment-section">
              ...
              >
                <div v-for="comment in comments" :key="comment.review?.id || comment.id" class="comment-item">
                  <img :src="comment.userProfile?.avatar || comment.avatar || defaultAvatar" class="comment-avatar" alt="用户头像" />
  ...
  const loadComments = async () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        commentHasMore.value = data.hasMore || false
        commentTotal.value = data.total || commentTotal.value
        commentPage.value++
      }
    } catch (error: any) {
