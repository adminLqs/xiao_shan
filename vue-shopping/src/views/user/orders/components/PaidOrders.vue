        ...
        <div class="order-header">
          <div class="order-header-top">
            ...
            <div class="order-status-group">
              <span v-if="!getOrderRefundStatus(orderWrapper)" class="order-status status-paid">已付款</span>
  ...
  if (orderItem.refundStatus) {
    try {
      ...
      if (response.success && response.data) {
        ...
        router.push({ name: 'Refund', query: { orderItemId: orderItem.id, orderId: orderWrapper.order.id, type: 'REFUND' } })
      }
    } catch {
      router.push({ name: 'Refund', query: { orderItemId: orderItem.id, orderId: orderWrapper.order.id, type: 'REFUND' } })
    }
